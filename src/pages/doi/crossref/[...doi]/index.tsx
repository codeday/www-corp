...
function getDatasetXml({ title, description, contributors, doiSuffix, publicationDate, license, funderName, funderIdentifier, sys }: any) {
...
function getPostedContentXml({ type, title, description, contributors, doiSuffix, publicationDate, license, funderName, funderIdentifier, sys }: any) {
...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  return {
    paths: query?.cms?.publications?.items?.map((i: any) => ({
      params: {
